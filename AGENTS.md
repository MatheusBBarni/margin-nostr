...
Exceptions: `/me` on the public site is a personal sent list, not a feed of other people's rooms. `/rooms` is a recent-window room list, not a home feed and not a complete ranking. Do not use either as a wedge for notifications or trending.
