...
Work **not** in the M0 (S0–S6) cycle. Requirements: `.specs/m0-proof-loop/plan.md`.

Status lives in each file. Do not pick a **done** task.
...
| File | Milestone | PRD |
| --- | --- | --- |
| [S7-follows-badge-mute.md](./S7-follows-badge-mute.md) | M1 | F9–F12, F17 |
| [S8-options-firefox-probe.md](./S8-options-firefox-probe.md) | M1 | F11 Firefox, options |
